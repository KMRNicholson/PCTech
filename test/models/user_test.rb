...
class UserTest < ActiveSupport::TestCase
  ...
  def setup
  	@user = User.new(name:"Example User", email:"user@example.com", password:"123456Tt!", password_confirmation:"123456Tt!")
  end
  ...
  test "password should be valid" do
    valid_passwords = %w[aaa1A! !!!aA1 111!aA]
  ...
  test "password shouldn't be invalid" do
    invalid_passwords = %w[aa!1A !!!aAAA 11!!!a 111!!A 111aaA]
